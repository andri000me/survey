...
function img_setuju($setuju = '')
{
	$gb = "<img id='link' src='" . base_url() . "asset/images/admtheme/icons/setujui.png' title='Setujui dan Kirim Barang' >$setuju";
	return $gb;
}

function img_sls($sls = '')
{
	$gb = "<img id='link' src='" . base_url() . "asset/images/admtheme/icons/setujui.png' title='Selesai Pengaduan' >$sls";
	return $gb;
}


function img_aktifasi($aktif = '')
{
	$gb = "<img id='link' src='" . base_url() . "asset/images/admtheme/icons/detail.png' title='Aktifasi UKM' >$aktif";
	return $gb;
}

function img_batal($batal = '')
{
	$gb = "<img id='link' src='" . base_url() . "asset/images/admtheme/icons/nosetujui.png' title='Batalkan Pemesanan' >$batal";
	return $gb;
}
