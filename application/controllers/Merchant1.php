...
/*	if($sta!=1){
		$data1 = array(
				...
				'ket' => 'Add Data Kecamatan '.$this->input->post('nama_kec'),
				'status' => 1
			);

		$insertlog = $this->kec->save_log($data1);
	}
*/
		$data['status'] = true;
		echo json_encode($data);
...
/*
		$data1 = array(
				'user' => $this->session->userdata('username'),
				'ket' => 'Update Data Kecamatan '.$this->input->post('nama_kec'),
				'status' => 2
			);
